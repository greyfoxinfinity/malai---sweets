      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-20">
        ...
        <div className="max-w-xl">
          ...
          <div className="mt-8 space-y-5 text-base leading-7 text-gray-600 md:leading-8">
            <p>
              At Malai, we believe the best moments are often the sweetest
              ones. We bring together familiar flavors, playful desserts, and
              carefully crafted treats made to brighten your day.
            </p>

            <p>
              From traditional sweets to modern desserts, every item is made
              with attention to detail and a whole lot of love.
            </p>
          </div>

          <Link href="/shop" className="mt-9 inline-block rounded-full border-b border-black px-6 py-3 text-sm font-medium text-black transition-opacity hover:opacity-60">Discover our menu →</Link>
        </div>
